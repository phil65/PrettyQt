...
The sources for PrettyQt can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/phil65/prettyqt
.. _tarball: https://github.com/phil65/prettyqt/tarball/master
