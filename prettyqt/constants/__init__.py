...
ChecksumType = Qt.ChecksumType
ClipOperation = Qt.ClipOperation
ColorScheme = Qt.ColorScheme
ConnectionType = Qt.ConnectionType
ContextMenuPolicy = Qt.ContextMenuPolicy
CoordinateSystem = Qt.CoordinateSystem
Corner = Qt.Corner
...
EventPriority = Qt.EventPriority
FillRule = Qt.FillRule
FindChildOption = Qt.FindChildOption
FocusPolicy = Qt.FocusPolicy
FocusReason = Qt.FocusReason
GestureFlag = Qt.GestureFlag
GestureState = Qt.GestureState
GestureType = Qt.GestureType
GlobalColor = Qt.GlobalColor
HighDpiScaleFactorRoundingPolicy = Qt.HighDpiScaleFactorRoundingPolicy
HitTestAccuracy = Qt.HitTestAccuracy
ImageConversionFlag = Qt.ImageConversionFlag
InputMethodHint = Qt.InputMethodHint
InputMethodQuery = Qt.InputMethodQuery
ItemDataRole = Qt.ItemDataRole
ItemFlag = Qt.ItemFlag
ItemSelectionMode = Qt.ItemSelectionMode
ItemSelectionOperation = Qt.ItemSelectionOperation
Key = Qt.Key
KeyboardModifier = Qt.KeyboardModifier
LayoutDirection = Qt.LayoutDirection
MaskMode = Qt.MaskMode
MatchFlag = Qt.MatchFlag
Modifier = Qt.Modifier
MouseButton = Qt.MouseButton
MouseEventFlag = Qt.MouseEventFlag
MouseEventSource = Qt.MouseEventSource
NativeGestureType = Qt.NativeGestureType
NavigationMode = Qt.NavigationMode
Orientation = Qt.Orientation
PenCapStyle = Qt.PenCapStyle
PenJoinStyle = Qt.PenJoinStyle
PenStyle = Qt.PenStyle
PermissionStatus = Qt.PermissionStatus
ScreenOrientation = Qt.ScreenOrientation
ScrollBarPolicy = Qt.ScrollBarPolicy
ScrollPhase = Qt.ScrollPhase
...
MOUSE_BUTTON: bidict[MouseButtonStr, Qt.MouseButton] = bidict(
    none=Qt.MouseButton.NoButton,
    # all=Qt.MouseButton.AllButtons,
    left=Qt.MouseButton.LeftButton,
    right=Qt.MouseButton.RightButton,
    middle=Qt.MouseButton.MiddleButton,
    back=Qt.MouseButton.BackButton,
    forward=Qt.MouseButton.ForwardButton,
    task=Qt.MouseButton.TaskButton,
    extra_4=Qt.MouseButton.ExtraButton4,
    extra_5=Qt.MouseButton.ExtraButton5,
    extra_6=Qt.MouseButton.ExtraButton6,
    extra_7=Qt.MouseButton.ExtraButton7,
    extra_8=Qt.MouseButton.ExtraButton8,
    extra_9=Qt.MouseButton.ExtraButton9,
    extra_10=Qt.MouseButton.ExtraButton10,
    extra_11=Qt.MouseButton.ExtraButton11,
    extra_12=Qt.MouseButton.ExtraButton12,
    extra_13=Qt.MouseButton.ExtraButton13,
    extra_14=Qt.MouseButton.ExtraButton14,
    extra_15=Qt.MouseButton.ExtraButton15,
    extra_16=Qt.MouseButton.ExtraButton16,
    extra_17=Qt.MouseButton.ExtraButton17,
    extra_18=Qt.MouseButton.ExtraButton18,
    extra_19=Qt.MouseButton.ExtraButton19,
    extra_20=Qt.MouseButton.ExtraButton20,
    extra_21=Qt.MouseButton.ExtraButton21,
    extra_22=Qt.MouseButton.ExtraButton22,
    extra_23=Qt.MouseButton.ExtraButton23,
