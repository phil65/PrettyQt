...
ALIGNMENTS = bidict(
    ...
    left=ALIGN_LEFT | ALIGN_V_CENTER,
    right=ALIGN_RIGHT | ALIGN_V_CENTER,
    top=ALIGN_H_CENTER | ALIGN_TOP,
    bottom=ALIGN_H_CENTER | ALIGN_BOTTOM,
...
KEY: bidict[KeyStr, Qt.Key] = bidict(
    ...
    singlecandidate=Qt.Key.Key_SingleCandidate,
    multiplecandidate=Qt.Key.Key_MultipleCandidate,
    previouscandidate=Qt.Key.Key_PreviousCandidate,
    ...
    volumedown=Qt.Key.Key_VolumeDown,
    volumemute=Qt.Key.Key_VolumeMute,
    bassboost=Qt.Key.Key_BassBoost,
    bassdown=Qt.Key.Key_BassDown,
    trebleup=Qt.Key.Key_TrebleUp,
    trebledown=Qt.Key.Key_TrebleDown,
    mediastop=Qt.Key.Key_MediaStop,
    mediaprevious=Qt.Key.Key_MediaPrevious,
    mediarecord=Qt.Key.Key_MediaRecord,
    mediatoggleplaypause=Qt.Key.Key_MediaTogglePlayPause,
    favorites=Qt.Key.Key_Favorites,
    standby=Qt.Key.Key_Standby,
    openurl=Qt.Key.Key_OpenUrl,
    launchmail=Qt.Key.Key_LaunchMail,
    launchmedia=Qt.Key.Key_LaunchMedia,
    launch1=Qt.Key.Key_Launch1,
    launch2=Qt.Key.Key_Launch2,
    launch3=Qt.Key.Key_Launch3,
    launch4=Qt.Key.Key_Launch4,
    launch5=Qt.Key.Key_Launch5,
    launch6=Qt.Key.Key_Launch6,
    launch7=Qt.Key.Key_Launch7,
    launch8=Qt.Key.Key_Launch8,
    launch9=Qt.Key.Key_Launch9,
    launcha=Qt.Key.Key_LaunchA,
    launchb=Qt.Key.Key_LaunchB,
    launchc=Qt.Key.Key_LaunchC,
    launchd=Qt.Key.Key_LaunchD,
    launche=Qt.Key.Key_LaunchE,
    launchf=Qt.Key.Key_LaunchF,
    launchg=Qt.Key.Key_LaunchG,
    launchh=Qt.Key.Key_LaunchH,
    monbrightnessup=Qt.Key.Key_MonBrightnessUp,
    monbrightnessdown=Qt.Key.Key_MonBrightnessDown,
    keyboardlightonoff=Qt.Key.Key_KeyboardLightOnOff,
    keyboardbrightnessup=Qt.Key.Key_KeyboardBrightnessUp,
    keyboardbrightnessdown=Qt.Key.Key_KeyboardBrightnessDown,
    screensaver=Qt.Key.Key_ScreenSaver,
    memo=Qt.Key.Key_Memo,
    lightbulb=Qt.Key.Key_LightBulb,
    history=Qt.Key.Key_History,
    addfavorite=Qt.Key.Key_AddFavorite,
    brightnessadjust=Qt.Key.Key_BrightnessAdjust,
    community=Qt.Key.Key_Community,
    audiorewind=Qt.Key.Key_AudioRewind,
    backforward=Qt.Key.Key_BackForward,
    applicationleft=Qt.Key.Key_ApplicationLeft,
    applicationright=Qt.Key.Key_ApplicationRight,
    calculator=Qt.Key.Key_Calculator,
    cleargrab=Qt.Key.Key_ClearGrab,
    display=Qt.Key.Key_Display,
    documents=Qt.Key.Key_Documents,
    explorer=Qt.Key.Key_Explorer,
    itouch=Qt.Key.Key_iTouch,
    logoff=Qt.Key.Key_LogOff,
    market=Qt.Key.Key_Market,
    meeting=Qt.Key.Key_Meeting,
    menupb=Qt.Key.Key_MenuPB,
    mysites=Qt.Key.Key_MySites,
    officehome=Qt.Key.Key_OfficeHome,
    phone=Qt.Key.Key_Phone,
    calendar=Qt.Key.Key_Calendar,
    reload=Qt.Key.Key_Reload,
    rotatewindows=Qt.Key.Key_RotateWindows,
    rotationkb=Qt.Key.Key_RotationKB,
    send=Qt.Key.Key_Send,
    spell=Qt.Key.Key_Spell,
    splitscreen=Qt.Key.Key_SplitScreen,
    taskpane=Qt.Key.Key_TaskPane,
    terminal=Qt.Key.Key_Terminal,
    travel=Qt.Key.Key_Travel,
    xfer=Qt.Key.Key_Xfer,
    zoomin=Qt.Key.Key_ZoomIn,
    zoomout=Qt.Key.Key_ZoomOut,
    messenger=Qt.Key.Key_Messenger,
    mailforward=Qt.Key.Key_MailForward,
    battery=Qt.Key.Key_Battery,
    bluetooth=Qt.Key.Key_Bluetooth,
    audioforward=Qt.Key.Key_AudioForward,
    audiorandomplay=Qt.Key.Key_AudioRandomPlay,
    audiocycletrack=Qt.Key.Key_AudioCycleTrack,
    hibernate=Qt.Key.Key_Hibernate,
    topmenu=Qt.Key.Key_TopMenu,
    powerdown=Qt.Key.Key_PowerDown,
    contrastadjust=Qt.Key.Key_ContrastAdjust,
    touchpadtoggle=Qt.Key.Key_TouchpadToggle,
    touchpadoff=Qt.Key.Key_TouchpadOff,
    green=Qt.Key.Key_Green,
    yellow=Qt.Key.Key_Yellow,
    channelup=Qt.Key.Key_ChannelUp,
    channeldown=Qt.Key.Key_ChannelDown,
    settings=Qt.Key.Key_Settings,
    micvolumeup=Qt.Key.Key_MicVolumeUp,
    micvolumedown=Qt.Key.Key_MicVolumeDown,
    open=Qt.Key.Key_Open,
    find=Qt.Key.Key_Find,
    undo=Qt.Key.Key_Undo,
    redo=Qt.Key.Key_Redo,
    medialast=Qt.Key.Key_MediaLast,
    camerafocus=Qt.Key.Key_CameraFocus,
    context2=Qt.Key.Key_Context2,
    context3=Qt.Key.Key_Context3,
    context4=Qt.Key.Key_Context4,
    hangup=Qt.Key.Key_Hangup,
    select=Qt.Key.Key_Select,
    togglecallhangup=Qt.Key.Key_ToggleCallHangup,
    lastnumberredial=Qt.Key.Key_LastNumberRedial,
